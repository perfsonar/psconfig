...
is($pscconfig->add_match_address("fe80::1"), 2);
is(@{$pscconfig->match_addresses()}, 2);
is($pscconfig->match_address(1), "fe80::1");
is($pscconfig->pscheduler_bind_map({'10.0.0.1'=>'10.0.0.2'})->{'10.0.0.1'}, '10.0.0.2');
is($pscconfig->include_directory('/etc/perfsonar/psconfig/pscheduler.d'), '/etc/perfsonar/psconfig/pscheduler.d');
