        ...
        raw_json = {
            ...
            "properties": {
                ...
                "grafana-datasource-type": {
                    "type": "string",
                    "description": "The type of datasource in Grafana"
                },

                "grafana-datasource-create": {
                    "type": "boolean",
                    "description": "Indicates whether we should automatically create datasources in Grafana if an existing match cannot be found. Default is true."
                },
            ...
            "pSConfig": {
                ...
                "Display": {
                    ...
                    "properties": {
                        ...
                        "archive_selector": {
                            "$ref": "#/pSConfig/ArchiveSelector",
                            "description": "Determines archive to be used to retrive data for display"
                        },
                        "priority": {
                    ...
                    "additionalProperties": False,
                    "required": [ "task_selector", "archive_selector", "stat_field", "stat_type", "row_field", "col_field", "value_field", "value_text", "unit", "thresholds" ]
                },
                ...
                "ArchiveSelector": {
                    "oneOf": [
                        { "$ref": "#/pSConfig/AutoArchiveSelector" },
                        { "$ref": "#/pSConfig/ManualArchiveSelector" }
                    ]
                },
                ...
                "AutoArchiveSelector": {
                    ...
                    "properties": {
                        "auto": {
                            "type": "boolean",
                            "enum": [ True ],
                            "description": "Indicates whether to automatically detect archiver from template or to use manual specification."
                        },
                        "types": {
                            "type": "array",
                            "items": { "type": "string" },
                            "description": "Match an archive in your pSConfig file if it is of any type in the list"
                        },
                        "names": {
                            "type": "array",
                            "items": { "type": "string" },
                            "description": "Match an archive in your pSConfig file if it has one of the names in the list"
                        },
                        "jq": { 
                            "$ref": "#/pSConfig/JQTransformSpecification",
                            "description": "Match an archive in your pSConfig file unless it is boolean false or an empty string"
                        }
                    },
                    "required": ["auto"],
                    "additionalProperties": False
                ...
                "ManualArchiveSelector": {
                    ...
                    "properties": {
                        ...
                        "datasource": { 
                            "$ref": "#/pSConfig/ManualDatasourceSpecification",
                            "description": "A manual specification or the datasource to use in Grafana"
                        }
                    },
                    "required": ["auto", "datasource"],
                    "additionalProperties": False
                },

                "ManualDatasourceSpecification": {
                    "type": "object",
                    "properties": {
                        "type": {
                            "type": "string",
                            "description": "The grafana datasource type"
                        },
                        "uid": {
                            "type": "string",
